...
'''
    Main function for the program. Simple Inversion
    counting can be done using insertion sort itself but using
    MergeSort is an efficient method
'''
